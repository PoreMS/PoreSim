...
# -*- coding: utf-8 -*-
#
# PoreSim documentation build configuration file, created by
...
# Install package
# if not "darwin" in sys.platform or "linux" in sys.platform:
...
html_theme_options = {
    ...
    'bootstrap_version': "3",
    'navbar_links': [("API", "api"), ("Simulation", "simulation"), ("Complex Pore Simulation", "simulation_complex"), ("Simulation 2-Phase", "simulation_2ph") ],
}
